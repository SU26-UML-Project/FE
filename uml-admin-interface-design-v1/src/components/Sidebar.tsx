import { LogOut, PanelLeftClose, PanelLeftOpen, Settings2, Sparkles, X } from "lucide-react";
            ...
            {!collapsed && (
              <>
                <div className="min-w-0 flex-1 leading-tight">
                  <p className="truncate text-[13px] font-medium text-slate-900">Nguyễn Minh Anh</p>
