/**
 * @deprecated Component này KHÔNG CÒN ĐƯỢC SỬ DỤNG.
 *
 * Tồn tại từ thời prototype, dùng `currentQuestion.type === 'multi_select'`
 * (lỗi thời, BE giờ trả `mode: "single" | "multiple"`).
 *
 * Component thay thế: `components/overlays/QuestionBox.tsx` (đang được
 * `components/panels/AIChat.tsx` sử dụng). File đó dùng `q.multiple` đúng
 * schema BE hiện tại.
 *
 * GIỮ file này để tham khảo, KHÔNG import. Có thể xoá sau khi team xác nhận
 * không có code nào phụ thuộc.
 */
