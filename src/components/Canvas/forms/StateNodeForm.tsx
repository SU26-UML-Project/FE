...
import type { StateNodeData } from '../custom-nodes/StateNode'
...
export function StateNodeForm({ node, setNodeData }: FormProps) {
  ...
  return (
    <div className="props-form">
      ...
      <div className="props-field">
        ...
        <input value={data.entry || ''} onChange={e => onChange('entry', e.target.value)} placeholder="e.g. init()" />
      </div>
      <div className="props-field">
        <label>Do Action</label>
        <input value={data.do || ''} onChange={e => onChange('do', e.target.value)} placeholder="e.g. processing()" />
      </div>
      <div className="props-field">
        <label>Exit Action</label>
        <input value={data.exit || ''} onChange={e => onChange('exit', e.target.value)} placeholder="e.g. cleanup()" />
      </div>
      <div className="props-field">
        <label>Color</label>
