...
import type { DecisionNodeData } from '../custom-nodes/DecisionNode'
...
export function DecisionNodeForm({ node, setNodeData }: FormProps) {
  ...
  return (
    <div className="props-form">
      <div className="props-field">
        ...
        <input value={data.label || ''} onChange={e => onChange('label', e.target.value)} placeholder="e.g. Valid?" />
      </div>
      <div className="props-field">
        <label>Color</label>
