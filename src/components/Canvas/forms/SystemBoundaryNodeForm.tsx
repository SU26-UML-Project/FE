...
import type { SystemBoundaryNodeData } from '../custom-nodes/SystemBoundaryNode'
...
export function SystemBoundaryNodeForm({ node, setNodeData }: FormProps) {
    const data = node.data as SystemBoundaryNodeData
        ...
        <div className="props-form">
            ...
            <div className="props-field">
                ...
                <div className="props-color-row">
                    {['#fff', '#f8fafc', '#fff8dc', '#e0ffff', '#e0ffe0', '#e0e0ff'].map((c) => (
                        <button
                            key={c}
