...
import type { DiagramDef, PaletteItem } from "../../../types/diagrams";
...
export function QuickAdd({
  ...
  return (
    <div
      ref={ref}
      className="animate-pop fixed z-50 w-[188px] rounded-xl border border-zinc-200 bg-white p-2 shadow-[0_8px_30px_rgba(0,0,0,0.16)]"
      ...
      <div className="grid grid-cols-3 gap-1">
        {diagram.nodes.map((item) => (
          <button
            ...
            title={item.label}
            className="group flex aspect-square flex-col items-center justify-center gap-1 rounded-lg border border-transparent text-zinc-500 transition-colors hover:border-zinc-200 hover:bg-zinc-50 hover:text-zinc-900"
          >
