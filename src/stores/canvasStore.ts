 ...
 function defaultNodeData(type: string): any { 
     switch (type) { 
         ...
         case 'systemBoundaryNode': 
             return {type: 'systemBoundaryNode', label: 'System'} 
         case 'initialNode':
     ...
     onConnect: (connection) => { 
                 ...
                 set((state) => { 
                     state.edges.push({ 
                         ...
                         type: getDefaultEdgeType(state.diagramType), 
                         style: {}, 
                         zIndex: state.diagramType === 'useCaseDiagram' ? 5 : 1, 
                     } as unknown as Edge) 
                 }) 
             }, 
